...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="page-header"><i class="fa fa-table"></i> Cursos</h3>
            </div><!-- /.col -->
            <div class="col-sm-6">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
            onclick="courseNuevo();">Agregar</button>
    </div><!-- /.container-fluid -->
</div>
<!-- /.content-header -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel">Gestionar Cursos</h4>
            ...
            <div class="modal-body">
                ...
                <form accept-charset="utf-8" id="course" name="course" method="POST" action=""
                enctype="multipart/form-data">
                    <div class="col s12 l6">
                    Elija un Carrera:
                        <select name="specialtyid" id="cargos" class="form-control">
                            <?php
                            $con = new connection();
                        ...
                        Elija un Ciclo:
                        <select name="cicle" id=""class="form-control">
            ...
            <div class="modal-footer">
                <input type="submit" name="nuevo" value="Nuevo" class="btn btn-secondary"
                    onclick="courseNuevo(); return false" />

                <input type="submit" name="btn" value="Grabar" class="btn btn-success"
                    onclick="courseInsert();return false" />

                <input type="submit" name="modificar" value="Modificar" class="btn btn-primary"
                    onclick="courseUpdate(); return false" />
