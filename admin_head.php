            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_person.php" class="nav-link">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_position.php" class="nav-link">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                                   Cargos
                                    <i class="fas fa-angle-left right"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_institute.php" class="nav-link">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                                   Institutos
                                    <i class="fas fa-angle-left right"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_specialty.php" class="nav-link">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                                   Carreras
                                    <i class="fas fa-angle-left right"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_registry.php" class="nav-link">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                                    Registros
                                    <i class="fas fa-angle-left right"></i>
                        ...
                        <li class="nav-item has-treeview">
                            <a href="admin_blog.php" class="nav-link">
                                <i class="nav-icon fas fa-table"></i>
                                <p>
                                    Blog
                                    <i class="fas fa-angle-left right"></i>
